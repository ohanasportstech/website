            ...
            children: [
              CustomScrollView(
                ...
                slivers: [
                  ...
                  SliverToBoxAdapter(child: _Reveal(child: _FeaturesSection(isMobile: isMobile), delayMs: 60)),
                  const SliverToBoxAdapter(child: _Separator()),
                  SliverToBoxAdapter(child: _Reveal(child: _HowItWorksSection(isMobile: isMobile), delayMs: 90)),
                  SliverToBoxAdapter(child: _Reveal(child: _PricingSection(isMobile: isMobile), delayMs: 120)),
                  const SliverToBoxAdapter(child: _Separator()),
                  SliverToBoxAdapter(child: _Reveal(child: _TestimonialsSection(isMobile: isMobile), delayMs: 150)),
                  SliverToBoxAdapter(child: _Reveal(child: _FaqSection(isMobile: isMobile), delayMs: 180)),
                  SliverToBoxAdapter(child: _Reveal(child: _ContactSection(isMobile: isMobile), delayMs: 210)),
                  SliverToBoxAdapter(child: _Reveal(child: _CtaSection(isMobile: isMobile), delayMs: 240)),
...
class _Reveal extends StatefulWidget {
  ...
  const _Reveal({super.key, required this.child, this.delayMs = 0, this.offsetFraction = 0.06});
...
class _RevealState extends State<_Reveal> {
  ...
  Widget build(BuildContext context) {
    return VisibilityDetector(
      ...
      child: AnimatedSlide(
        offset: _shown ? Offset.zero : Offset(0, widget.offsetFraction),
...
class _Pill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Text(text, style: TextStyle(color: color.onPrimaryContainer)),
    );
  }
}
                ...
                child: Align(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'App + Smart Module to control your ball machine with ease. Warm coaching, sporty energy, and data that helps you grow.',
                        textAlign: TextAlign.center,
                        ...
                        children: [
                          FilledButton(
                            ...
                            style: FilledButton.styleFrom(
                              ...
                              overlayColor: MaterialStatePropertyAll(color.primary.withOpacity(0.08)),
                            ),
                          ...
                          OutlinedButton(
                            ...
                            child: const Text('Meet the Smart Module'),
                          ),
                        ],
                      ),
                    ],
      ...
      child: ConstrainedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              'The Kai Tennis app pairs with our Smart Module to bring pro-level controls to your existing ball machine. Set drills, tweak speed and spin, and track progress—without breaking rhythm.',
  ...
  Widget build(BuildContext context) {
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: color.surfaceContainerHighest.withOpacity(_hovering ? 0.92 : 1),
          borderRadius: BorderRadius.circular(20),
          border: Border.all(color: color.outlineVariant),
          boxShadow: _hovering
              ? [
                  BoxShadow(color: Colors.black.withOpacity(0.12), blurRadius: 24, spreadRadius: 0, offset: const Offset(0, 12)),
                ]
              : [],
        ),
        child: Column(
      ...
      child: ConstrainedBox(
        ...
        child: Column(
          ...
          children: const [
            ...
            SizedBox(height: 16),
            _Step(number: '1', title: 'Connect', desc: 'Attach the Smart Module to your ball machine and pair via Bluetooth.'),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Smart Module', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w700)),
                      const SizedBox(height: 8),
                      const Text('Preorder pricing • Limited early units'),
                      const SizedBox(height: 12),
                      OutlinedButton(onPressed: () {}, child: const Text('Join waitlist')),
                    ],
                  ),
                ),
              ],
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text('Have a question about the app or Smart Module? We’d love to hear from you.',
              ...
              const SizedBox(height: 8),
              Text('Prefer email? hello@ohanasports.com', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: color.onSurfaceVariant)),
            ],
          ),
        ),
      ),
...
class _CtaSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [color.primary.withOpacity(.1), color.surface],
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                FilledButton(onPressed: () {}, child: const Text('Get the App')),
                OutlinedButton(onPressed: () {}, child: const Text('Join the Waitlist')),
              ],
            ),
          ],
        ),
            ...
            child: BackdropFilter(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.sports_tennis, color: color.primary),
                      const SizedBox(width: 8),
                      ...
                      TextButton(onPressed: () {}, child: const Text('Smart Module')),
